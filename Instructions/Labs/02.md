...
1. In the search bar of the Azure portal, type **Sentinel (1)**, then select **Microsoft Sentinel (2)** from the search results.
...
5. Notice that the **Result count** post-query runs within the metrics bar of the **Microsoft Sentinel | Hunting** page. These results of the query runs appear for specific query logs that have been identified.
   ...
   ![search sentinel](../media/20032025(22).png)
...
1. On the Microsoft Sentinel page, follow the below instructions to install the data connector:
   ...
   - Click on **Install with dependencies (4)** in the right navigation pane.

     ![search sentinel](../media/20032025(23).png)

1. Select the **Log4J Vulnerability Detection (1)** solution and click on **Install** in the right navigation pane.

     ![search sentinel](../media/20032025(24).png)

      >**Note:** The installation may take up to a minute. Wait for the **Install Success** notification, after which you can now notice the **Installed** count has increased to **3**.

      ![search sentinel](../media/20032025(25).png)

1. Select **Hunting** under the **Threat management** section, and follow the below instructions to create a new hunt based on the installed **Log4J Vulnerability Detection** solution:
...
1. Click on **MITRE ATT&CK (Preview) (1)** under the **Threat management** section. Within the **Microsoft Sentinel | MITRE ATT&CK (Preview)** page, perform the following: 
   ...
   - **Active rules**: Unselect all the checkboxes from the dropdown. **(2)**

      ![search sentinel](../media/20032025(26).png)

   - **Simulated rules**: Ensure only **Hunting queries (3)** are selected.

     ![search sentinel](../media/20032025(29).png)
...
2. As an example, select the **Account Manipulation (1)** card and then click on the **View (2)** link next to Hunting queries at the bottom of the details pane. This link takes you to a filtered view of the Queries tab on the Hunting page based on the technique you selected. 
   ...
   ![search sentinel](../media/20032025(28).png)
...
3. Within the **Hunt** details page,
...
5. Staying on the current **Hunt** page has a list of all the selected queries that were added to the hunt in the previous step, click on **Run all queries**.
...
3. Click on the **Create analytics rule** from the list of managing options to create a new analytics rule.

   ![create analytics rule](../media/create-analytics-rule.png)

4. On the **Analytics rule wizard - Create a new Scheduled rule** page, leave all configurations at default and navigate to the **Review and create (1)** tab. Click on **Save (2)** to create the new scheduled rule.
...
3. In the **Hunt** details page, click on **Run all queries** and wait for the queries to run. 

   ![hunt details](../media/run-all-queries-new1.png)

4. Click on **Add Filter (1)** and select **Results (2)**.

   ![hunt details](../media/20032025(30).png)

1. Set the filter to display queries with at least **one (1)** result and click on **Apply (2)**.

   ![hunt details](../media/20032025(32).png)
...
4. Select a query **(1)** from the filtered list and click **View results (2)** in the hunting query details pane to view the result logs.
   ...
   ![hunt details](../media/20032025(33).png)
...
5. Use the checkboxes to select rows that contain the information **(1)** and click on **Add bookmark (2)**. This preserves the data in the row for future reference. 
   ...
   ![hunt details](../media/20032025(34).png)
...
6. In the **Add bookmark** pane that shows up, note the default **Bookmark name (1)** and click on the **Create (2)** button. Leave the other configurations set to default.
   ...
   > **Note:** If you did not see any output of the query, you will not be able to add it to the bookmark. this will not create any hurdle to your next step, please proceed with the next Task.
...
1. Navigate to the Windows Security Events and M365 hunt details page and click on the **Bookmarks** tab to view the newly created bookmark.
   ...
   ![hunt details](../media/20032025(35).png)
...
1. Within the **Hunt** page, select the **Actions** **(1)** menu and then click on **Create incident** **(2)**.
   ...
   ![hunt details](../media/20032025(36).png)

1. On the Create Incident wizard, click **Next: Bookmarks**

1. Use the **Add bookmarks** action to choose bookmarks from the hunt to add to the incident. You're limited to bookmarks that haven't already been assigned to an incident.
